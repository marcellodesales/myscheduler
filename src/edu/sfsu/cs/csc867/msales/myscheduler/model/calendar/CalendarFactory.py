...
if __name__ == '__main__':
    ...
    smallestEnd = a.getEndDateTime() if a.getStartDateTime() < b.getStartDateTime() else b.getEndDateTime()
    otherStart = b.getStartDateTime() if a.getStartDateTime() == smallestEnd else a.getStartDateTime()
    ...
    print "Conflicts!!!" if smallestEnd > otherStart else "Don't conflict"
    ...
    cal = CalendarFactory().buildNewCalendar(doct, [e, e1])
    cal.printAll()
    
    newEvent = CalendarFactory().buildNewEvent(pat, CalendarFactory().buildNewTimeSlot(s, f, 5, TimeSlot.DURATION_HOUR)
                                               , "A new different topic...")
