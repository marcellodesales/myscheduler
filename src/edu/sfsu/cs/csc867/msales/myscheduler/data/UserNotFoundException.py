...
class UserNotFoundException(MySchedulerException):
    
    def __new__(cls, message, varsValueDic = {}):
        return super(UserNotFoundException, cls).__new__(cls, message, varsValueDic)
...
if __name__ == '__main__':
    print UserNotFoundException("message").getId()